...
const TextEditor::LanguageDefinition* TextEditor::LanguageDefinition::GLSL()
{
	...
	if (!inited)
	{
		...
		static const char* const keywords[] = {
			...
			"_Noreturn", "_Static_assert", "_Thread_local", "bool", "vec2", "vec3", "vec4", "mat2", "mat3", "mat4"
		};
		for (auto& k : keywords)
			langDef->mKeywords.insert(k);
		...
		static const char* const identifiers[] = {
			...
			"uniform", "layout", "dot", "max", "min", "in", "out", "mix", "normalize", "texture", "clamp", "distance", "length", "isnan", "cross"
		};
		for (auto& k : identifiers)
		{
			Identifier id;
