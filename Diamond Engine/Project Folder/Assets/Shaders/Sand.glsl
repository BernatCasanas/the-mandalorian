...
void main()
{
    ...
    vs_out.TexCoords = texCoord * 10.0;
...
void main()
{
    ...
    vec3 normalLightDir = normalize(fs_in.TangentLightPos - fs_in.TangentFragPos);
    float normalDiff = max(dot(normalLightDir, normal), 0.0);
    float finalDiff = normalDiff + diff;
    vec3 diffuse = finalDiff * lightColor;
