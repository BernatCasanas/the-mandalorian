...
public class Rooms : DiamondComponent
{
	...
	public void Update(/*int x*/)
	{
		...
		if (instantiate && spawnpoint != null)
		{
			instantiate = false;

			InternalCalls.CreateRoom(spawnpoint.globalPosition, spawnpoint.globalRotation, spawnpoint.globalScale);
		}
		else
			return;
