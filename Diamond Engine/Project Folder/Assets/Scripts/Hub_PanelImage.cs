...
public class Hub_PanelImage : DiamondComponent
{
    ...
    public void Awake()
    {
        ...
        0, 957705934,1372558958, 199890712, 897227592, 2025342343, 435516336, 761216663,
        0, 1063854057, 2019801014, 1189706487, 111066637, 1629205377, 1116284871, 1583302608,
        775271058, 292345320, 1671001101, 1136043790, 681984580, 1732492657, 157271948, 1558659302 };
        weaponIcons = new int[19] {
        957705934, 2098479941, 664499657, 1189706487, 111066637, 2037896323, 1063854057,
        430313587, 1189706487, 1465364877, 2098479941, 111066637, 2037896323,
        1189706487, 1809967235, 1683429269, 961618377, 111066637, 1030329892 };
    }
