...
{
    public BobbaStunAmmo() : base(1240646973, RewardType.REWARD_BOON, 1.0f, " Proc ratio and area on grenade boosted by ½")
    {
        name = "Cad Bane’s rocket boots";
        price = ShopPrice.SHOP_EXPENSIVE;
    }
    ...
    public override void Use()
    {
        if (Core.instance != null)
        {
            Core.instance.AddStatus(STATUS_TYPE.BOBBA_STUN_AMMO, STATUS_APPLY_TYPE.ADDITIVE, 50, 0, true);
